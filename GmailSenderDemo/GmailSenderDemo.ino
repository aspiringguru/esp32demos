/* Arduino core for ESP32 WiFi chip SMTP Gmail sender
   ...
   in gmail - turn on 'less security' for apps.
...
//to get password > netsh wlan show profile name=”sleepyVenus” key=clear
//const char* ssid = "SleepyGuest24";                           // WIFI network name
//const char* password = "sleepyHollow";                       // WIFI network password
const char* ssid = "sleepyVenus";                           // WIFI network name
const char* password = "Qazwsx123";                       // WIFI network password
