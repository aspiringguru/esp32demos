...
modify this to detect voltage in mains feed
if mains voltage off peak is zero
...
const char* wifi_name = "SleepyGuest24"; // Your Wifi network name here
const char* wifi_pass = "sleepyHollow";    // Your Wifi network password here
